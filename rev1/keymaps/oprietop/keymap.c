...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CO] = LAYOUT( /* COLEMAK MOD-DH*/
    ...
    KC_GRV,  KC_A,    KC_R,    KC_S,    KC_T,    KC_G,   KC_MINS,        KC_EQL,   KC_M,   KC_N,       KC_E,    KC_I,    KC_O,    KC_QUOT, \
    KC_MINS, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,   KC_TAB,         KC_BSLS,  KC_K,   KC_H,       KC_COMM, KC_DOT,  KC_SLSH, KC_EQL,  \
    KC_RCTL, KC_INS,  KC_LALT, KC_LGUI, NT_ESC,  LSTAB,  LT_DEL,         LT_BSPC,  RSSP,   KC_ENT,     KC_RGUI, KC_RALT, KC_RGUI, KC_LCTL  \
  ),
  [_QW] = LAYOUT( /* QWERTY */
  ...
  [_NP] = LAYOUT( /* NUMPAD */ 
    ...
    RESET  , TG(_QW),   _______, _______, _______, _______,  _______,     _______, _______, KC_PENT, KC_P0,   KC_PDOT, _______, _______  \
  ),
};
